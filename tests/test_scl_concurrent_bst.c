...
static void test_cbst_concurrent_insert(scl_test_runner_t *tr) {
    ...
    SCL_EXPECT_EQ_SZ(tr, scl_cbst_count(&t), (size_t)(NTHREADS *
OPS_PER_THREAD)); scl_cbst_destroy(alloc, &t); TEST_TRACE_END();
}
*/
