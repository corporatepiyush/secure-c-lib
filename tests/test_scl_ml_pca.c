...
static void test_pca_fit_transform(scl_test_runner_t *tr) {
  ...
  ds.data[1] = 0;
  ds.data[2] = 1;
  ds.data[ds.row_stride + 0] = 0;
  ds.data[ds.row_stride + 1] = 1;
  ds.data[ds.row_stride + 2] = 1;
  ds.data[2 * ds.row_stride + 0] = 2;
  ds.data[2 * ds.row_stride + 1] = 1;
  ds.data[2 * ds.row_stride + 2] = 3;
  ds.data[3 * ds.row_stride + 0] = -1;
  ds.data[3 * ds.row_stride + 1] = 0;
  ds.data[3 * ds.row_stride + 2] = -1;
