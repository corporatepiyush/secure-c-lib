...
scl_error_t scl_hash_insert(scl_hash_t *ht, const void *key, const void *value) SCL_WARN_UNUSED;
scl_error_t scl_hash_get(const scl_hash_t *ht, const void *key, void *out_value) SCL_WARN_UNUSED;
scl_error_t scl_hash_remove(scl_hash_t *ht, const void *key) SCL_WARN_UNUSED;
