...
typedef size_t (*scl_concurrent_hash_func_t)(const void *key, size_t len);
...
typedef struct {
    ...
    size_t bucket_count;
    atomic_size_t count;
    scl_concurrent_hash_func_t hash_func;
    size_t key_size;
    size_t value_size;
} scl_concurrent_hash_t;

scl_error_t scl_concurrent_hash_init(scl_concurrent_hash_t *ht, size_t key_size, size_t value_size,
                                     size_t bucket_count, scl_concurrent_hash_func_t hf) SCL_WARN_UNUSED;
void        scl_concurrent_hash_destroy(scl_concurrent_hash_t *ht);
scl_error_t scl_concurrent_hash_insert(scl_concurrent_hash_t *ht, const void *key, const void *value) SCL_WARN_UNUSED;
scl_error_t scl_concurrent_hash_get(const scl_concurrent_hash_t *ht, const void *key, void *out_value) SCL_WARN_UNUSED;
scl_error_t scl_concurrent_hash_remove(scl_concurrent_hash_t *ht, const void *key) SCL_WARN_UNUSED;
