...
scl_error_t scl_atomic_deque_init(scl_allocator_t *alloc, scl_atomic_deque_t *deque, size_t element_size, size_t capacity)
{
...
scl_error_t scl_atomic_deque_push_front(scl_allocator_t *alloc, scl_atomic_deque_t *deque, const void *element)
{
    (void)alloc;
...
scl_error_t scl_atomic_deque_push_back(scl_allocator_t *alloc, scl_atomic_deque_t *deque, const void *element)
{
    (void)alloc;
    if (!deque || !element) return SCL_ERR_NULL_PTR;
    scl_spinlock_lock(&deque->lock);
...
scl_error_t scl_atomic_deque_pop_front(scl_atomic_deque_t *deque, void *out)
{
...
scl_error_t scl_atomic_deque_pop_back(scl_atomic_deque_t *deque, void *out)
{
    if (!deque || !out) return SCL_ERR_NULL_PTR;
    scl_spinlock_lock(&deque->lock);
    size_t cnt = atomic_load_explicit(&deque->count, memory_order_relaxed);
