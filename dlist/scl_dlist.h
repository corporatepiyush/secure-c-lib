...
scl_error_t scl_dlist_push_front(scl_dlist_t *list, const void *element) SCL_WARN_UNUSED;
scl_error_t scl_dlist_push_back(scl_dlist_t *list, const void *element) SCL_WARN_UNUSED;
scl_error_t scl_dlist_pop_front(scl_dlist_t *list, void *out) SCL_WARN_UNUSED;
scl_error_t scl_dlist_pop_back(scl_dlist_t *list, void *out) SCL_WARN_UNUSED;
...
scl_error_t scl_dlist_insert_at(scl_dlist_t *list, size_t index, const void *element) SCL_WARN_UNUSED;
scl_error_t scl_dlist_remove_at(scl_dlist_t *list, size_t index, void *out) SCL_WARN_UNUSED;
