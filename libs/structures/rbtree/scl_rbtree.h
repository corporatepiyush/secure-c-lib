...
scl_error_t scl_rbtree_init(scl_allocator_t *SCL_RESTRICT alloc,
                            scl_rbtree_t *SCL_RESTRICT tree,
                            size_t element_size,
                            scl_cmp_func_t cmp) SCL_WARN_UNUSED;
void scl_rbtree_destroy(scl_allocator_t *SCL_RESTRICT alloc,
                        scl_rbtree_t *SCL_RESTRICT tree);
scl_error_t scl_rbtree_insert(scl_allocator_t *SCL_RESTRICT alloc,
                              scl_rbtree_t *SCL_RESTRICT tree,
                              const void *SCL_RESTRICT element) SCL_WARN_UNUSED;
scl_error_t scl_rbtree_remove(scl_allocator_t *SCL_RESTRICT alloc,
                              scl_rbtree_t *SCL_RESTRICT tree,
                              const void *SCL_RESTRICT key) SCL_WARN_UNUSED;
SCL_PURE bool scl_rbtree_contains(const scl_rbtree_t *SCL_RESTRICT tree,
                                  const void *SCL_RESTRICT key);
scl_error_t scl_rbtree_find(const scl_rbtree_t *SCL_RESTRICT tree,
                            const void *SCL_RESTRICT key,
                            void *SCL_RESTRICT out) SCL_WARN_UNUSED;
scl_error_t scl_rbtree_min(const scl_rbtree_t *SCL_RESTRICT tree,
                           void *SCL_RESTRICT out) SCL_WARN_UNUSED;
scl_error_t scl_rbtree_max(const scl_rbtree_t *SCL_RESTRICT tree,
                           void *SCL_RESTRICT out) SCL_WARN_UNUSED;
...
scl_error_t scl_rbtree_inorder(const scl_rbtree_t *SCL_RESTRICT tree,
