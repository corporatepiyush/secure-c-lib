...
void        scl_hash_destroy(scl_allocator_t *SCL_RESTRICT alloc, scl_hash_t *SCL_RESTRICT ht);
scl_error_t scl_hash_insert(scl_allocator_t *SCL_RESTRICT alloc, scl_hash_t *SCL_RESTRICT ht, const void *SCL_RESTRICT key, const void *SCL_RESTRICT value) SCL_WARN_UNUSED;
scl_error_t scl_hash_get(const scl_hash_t *SCL_RESTRICT ht, const void *SCL_RESTRICT key, void *SCL_RESTRICT out_value) SCL_WARN_UNUSED;
scl_error_t scl_hash_remove(scl_allocator_t *SCL_RESTRICT alloc, scl_hash_t *SCL_RESTRICT ht, const void *SCL_RESTRICT key) SCL_WARN_UNUSED;
SCL_PURE bool        scl_hash_contains(const scl_hash_t *SCL_RESTRICT ht, const void *SCL_RESTRICT key);
...
bool   scl_hash_eq_mem(const void *SCL_RESTRICT a, const void *SCL_RESTRICT b, size_t key_size);
