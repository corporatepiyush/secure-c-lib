...
scl_error_t scl_fenwick_update(scl_fenwick_t *fw, size_t idx,
                               const void *SCL_RESTRICT delta) {
...
scl_error_t scl_fenwick_prefix(const scl_fenwick_t *fw, size_t idx,
...
scl_error_t scl_fenwick_range_query(const scl_fenwick_t *fw, size_t l, size_t r,
                                    void *SCL_RESTRICT out) {
  if (scl_unlikely(!fw || !out))
    return SCL_ERR_NULL_PTR;
