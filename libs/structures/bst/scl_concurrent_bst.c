...
static scl_concurrent_bst_node_t *
create_node(scl_allocator_t *alloc, const void *data, size_t element_size) {
  scl_concurrent_bst_node_t *n =
      scl_alloc(alloc, sizeof(scl_concurrent_bst_node_t) + element_size,
                alignof(max_align_t));
  if (!n)
    return NULL;
...
void scl_cbst_destroy(scl_allocator_t *alloc, scl_concurrent_bst_t *tree) {
  ...
  if (tree->root) {
    size_t cap = 64;
    scl_concurrent_bst_node_t **stack =
...
scl_error_t scl_cbst_insert(scl_allocator_t *alloc, scl_concurrent_bst_t *tree,
...
scl_error_t scl_cbst_remove(scl_allocator_t *alloc, scl_concurrent_bst_t *tree,
...
scl_error_t scl_cbst_find(scl_concurrent_bst_t *tree, const void *key,
