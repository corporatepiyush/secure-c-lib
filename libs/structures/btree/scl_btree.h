 ...
 *   [scl_btree_node_t header] [keys: key_size * max_keys] [values: value_size *
 * max_keys] [children: ptr * max_children] */
...
static inline unsigned char *scl_btree_node_vals(scl_btree_node_t *n,
                                                 size_t ksz, size_t maxk) {
  return (unsigned char *)(n + 1) + ksz * maxk;
}
static inline scl_btree_node_t **scl_btree_node_children(scl_btree_node_t *n,
                                                         size_t ksz, size_t vsz,
                                                         size_t maxk) {
  return (scl_btree_node_t **)((unsigned char *)(n + 1) + ksz * maxk +
                               vsz * maxk);
}
...
void scl_btree_destroy(scl_allocator_t *SCL_RESTRICT alloc,
                       scl_btree_t *SCL_RESTRICT tree);
scl_error_t scl_btree_insert(scl_allocator_t *SCL_RESTRICT alloc,
                             scl_btree_t *SCL_RESTRICT tree,
                             const void *SCL_RESTRICT key,
                             const void *SCL_RESTRICT value) SCL_WARN_UNUSED;
scl_error_t scl_btree_get(const scl_btree_t *SCL_RESTRICT tree,
                          const void *SCL_RESTRICT key,
                          void *SCL_RESTRICT out_value) SCL_WARN_UNUSED;
scl_error_t scl_btree_remove(scl_allocator_t *SCL_RESTRICT alloc,
                             scl_btree_t *SCL_RESTRICT tree,
                             const void *SCL_RESTRICT key) SCL_WARN_UNUSED;
SCL_PURE bool scl_btree_contains(const scl_btree_t *SCL_RESTRICT tree,
                                 const void *SCL_RESTRICT key);
