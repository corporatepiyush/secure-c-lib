...
scl_error_t scl_cslist_init(scl_allocator_t *SCL_RESTRICT alloc,
                            scl_concurrent_slist_t *SCL_RESTRICT list,
                            size_t element_size) SCL_WARN_UNUSED;
void scl_cslist_destroy(scl_allocator_t *SCL_RESTRICT alloc,
                        scl_concurrent_slist_t *SCL_RESTRICT list);
scl_error_t
scl_cslist_push_front(scl_allocator_t *SCL_RESTRICT alloc,
                      scl_concurrent_slist_t *SCL_RESTRICT list,
                      const void *SCL_RESTRICT element) SCL_WARN_UNUSED;
scl_error_t scl_cslist_pop_front(scl_allocator_t *SCL_RESTRICT alloc,
                                 scl_concurrent_slist_t *SCL_RESTRICT list,
                                 void *SCL_RESTRICT out) SCL_WARN_UNUSED;
SCL_PURE size_t
scl_cslist_count(const scl_concurrent_slist_t *SCL_RESTRICT list);
