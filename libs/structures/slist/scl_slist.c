...
static scl_error_t scl_slist_create_node(scl_allocator_t *alloc,
                                         scl_slist_node_t **out,
                                         const void *data,
                                         size_t element_size) {
  size_t node_sz;
...
scl_error_t scl_slist_push_front(scl_allocator_t *alloc, scl_slist_t *list,
...
scl_error_t scl_slist_push_back(scl_allocator_t *alloc, scl_slist_t *list,
                                const void *SCL_RESTRICT element) {
  if (scl_unlikely(!list || !element))
    return SCL_ERR_NULL_PTR;
  size_t esz = list->element_size;
...
scl_error_t scl_slist_pop_front(scl_allocator_t *alloc, scl_slist_t *list,
...
scl_error_t scl_slist_remove(scl_allocator_t *alloc, scl_slist_t *list,
                             const void *element,
...
scl_error_t scl_slist_search(const scl_slist_t *restrict list,
