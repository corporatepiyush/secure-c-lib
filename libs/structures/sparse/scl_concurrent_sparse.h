...
scl_error_t scl_csparse_init(
    scl_allocator_t *alloc, scl_concurrent_sparse_t *st, size_t n,
    size_t element_size, const void *data,
    void (*combine)(void *SCL_RESTRICT out, const void *SCL_RESTRICT a,
                    const void *SCL_RESTRICT b)) SCL_WARN_UNUSED;
void scl_csparse_destroy(scl_allocator_t *SCL_RESTRICT alloc,
                         scl_concurrent_sparse_t *SCL_RESTRICT st);
scl_error_t scl_csparse_query(const scl_concurrent_sparse_t *SCL_RESTRICT st,
                              size_t l, size_t r,
