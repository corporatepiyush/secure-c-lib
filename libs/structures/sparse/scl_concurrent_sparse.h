...
void        scl_csparse_destroy(scl_allocator_t *SCL_RESTRICT alloc, scl_concurrent_sparse_t *SCL_RESTRICT st);
scl_error_t scl_csparse_query(const scl_concurrent_sparse_t *SCL_RESTRICT st, size_t l, size_t r, void *SCL_RESTRICT out) SCL_WARN_UNUSED;
