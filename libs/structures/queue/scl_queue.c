...
scl_error_t scl_queue_init(scl_allocator_t *alloc, scl_queue_t *queue,
...
scl_error_t scl_queue_enqueue(scl_allocator_t *alloc, scl_queue_t *queue,
...
scl_error_t scl_queue_peek(const scl_queue_t *queue, void *out) {
  ...
  scl_memcpy(out, queue->data + queue->head * queue->element_size,
             queue->element_size);
  return SCL_OK;
}
...
scl_error_t scl_queue_search(const scl_queue_t *restrict queue,
