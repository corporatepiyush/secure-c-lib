...
scl_error_t scl_cqueue_init(scl_allocator_t *SCL_RESTRICT alloc,
                            scl_concurrent_queue_t *SCL_RESTRICT queue,
                            size_t element_size) SCL_WARN_UNUSED;
void scl_cqueue_destroy(scl_allocator_t *SCL_RESTRICT alloc,
                        scl_concurrent_queue_t *SCL_RESTRICT queue);
scl_error_t
scl_cqueue_enqueue(scl_allocator_t *SCL_RESTRICT alloc,
                   scl_concurrent_queue_t *SCL_RESTRICT queue,
                   const void *SCL_RESTRICT element) SCL_WARN_UNUSED;
scl_error_t scl_cqueue_dequeue(scl_allocator_t *SCL_RESTRICT alloc,
                               scl_concurrent_queue_t *SCL_RESTRICT queue,
                               void *SCL_RESTRICT out) SCL_WARN_UNUSED;
SCL_PURE size_t
scl_cqueue_count(const scl_concurrent_queue_t *SCL_RESTRICT queue);
SCL_PURE bool
scl_cqueue_empty(const scl_concurrent_queue_t *SCL_RESTRICT queue);
