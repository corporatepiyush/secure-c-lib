...
void scl_cavl_destroy(scl_allocator_t *SCL_RESTRICT alloc,
                      scl_concurrent_avl_t *SCL_RESTRICT tree);
scl_error_t scl_cavl_insert(scl_allocator_t *SCL_RESTRICT alloc,
                            scl_concurrent_avl_t *SCL_RESTRICT tree,
                            const void *SCL_RESTRICT element) SCL_WARN_UNUSED;
scl_error_t scl_cavl_remove(scl_allocator_t *SCL_RESTRICT alloc,
                            scl_concurrent_avl_t *SCL_RESTRICT tree,
                            const void *SCL_RESTRICT key) SCL_WARN_UNUSED;
SCL_PURE bool scl_cavl_contains(scl_concurrent_avl_t *SCL_RESTRICT tree,
                                const void *SCL_RESTRICT key);
scl_error_t scl_cavl_find(scl_concurrent_avl_t *SCL_RESTRICT tree,
                          const void *SCL_RESTRICT key,
