...
void scl_ringbuf_destroy(scl_allocator_t *SCL_RESTRICT alloc,
                         scl_ringbuf_t *SCL_RESTRICT rb);
scl_error_t scl_ringbuf_push(scl_ringbuf_t *SCL_RESTRICT rb,
                             const void *SCL_RESTRICT element) SCL_WARN_UNUSED;
scl_error_t scl_ringbuf_pop(scl_ringbuf_t *SCL_RESTRICT rb,
                            void *SCL_RESTRICT out) SCL_WARN_UNUSED;
scl_error_t scl_ringbuf_peek(const scl_ringbuf_t *SCL_RESTRICT rb, size_t index,
                             void *SCL_RESTRICT out) SCL_WARN_UNUSED;
