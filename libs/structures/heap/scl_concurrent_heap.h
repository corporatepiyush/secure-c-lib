...
void scl_cheap_destroy(scl_allocator_t *SCL_RESTRICT alloc,
                       scl_concurrent_heap_t *SCL_RESTRICT heap);
scl_error_t scl_cheap_push(scl_allocator_t *SCL_RESTRICT alloc,
                           scl_concurrent_heap_t *SCL_RESTRICT heap,
                           const void *SCL_RESTRICT element) SCL_WARN_UNUSED;
scl_error_t scl_cheap_pop(scl_allocator_t *SCL_RESTRICT alloc,
                          scl_concurrent_heap_t *SCL_RESTRICT heap,
                          void *SCL_RESTRICT out) SCL_WARN_UNUSED;
scl_error_t scl_cheap_peek(scl_concurrent_heap_t *SCL_RESTRICT heap,
                           void *SCL_RESTRICT out) SCL_WARN_UNUSED;
