...
void scl_heap_destroy(scl_allocator_t *SCL_RESTRICT alloc,
                      scl_heap_t *SCL_RESTRICT heap);
scl_error_t scl_heap_push(scl_allocator_t *SCL_RESTRICT alloc,
                          scl_heap_t *SCL_RESTRICT heap,
                          const void *SCL_RESTRICT element) SCL_WARN_UNUSED;
scl_error_t scl_heap_pop(scl_heap_t *SCL_RESTRICT heap,
                         void *SCL_RESTRICT out) SCL_WARN_UNUSED;
scl_error_t scl_heap_peek(const scl_heap_t *SCL_RESTRICT heap,
                          void *SCL_RESTRICT out) SCL_WARN_UNUSED;
