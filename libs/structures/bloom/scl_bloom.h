...
void scl_bloom_destroy(scl_allocator_t *SCL_RESTRICT alloc,
                       scl_bloom_t *SCL_RESTRICT bf);
scl_error_t scl_bloom_insert(scl_bloom_t *SCL_RESTRICT bf,
                             const void *SCL_RESTRICT data,
                             size_t len) SCL_WARN_UNUSED;
SCL_PURE bool scl_bloom_maybe_contains(const scl_bloom_t *SCL_RESTRICT bf,
                                       const void *SCL_RESTRICT data,
                                       size_t len);
...
size_t scl_bloom_hash_murmur(const void *SCL_RESTRICT data, size_t len,
                             size_t seed);
