...
scl_error_t scl_ctrie_init(scl_allocator_t *SCL_RESTRICT alloc,
                           scl_concurrent_trie_t *SCL_RESTRICT trie,
                           size_t value_size) SCL_WARN_UNUSED;
void scl_ctrie_destroy(scl_allocator_t *SCL_RESTRICT alloc,
                       scl_concurrent_trie_t *SCL_RESTRICT trie);
