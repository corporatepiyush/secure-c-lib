...
scl_error_t scl_trie_init(scl_allocator_t *alloc, scl_trie_t *trie, size_t value_size) SCL_WARN_UNUSED;
...
scl_error_t scl_trie_remove(scl_allocator_t *alloc, scl_trie_t *trie, const unsigned char *key, size_t key_len) SCL_WARN_UNUSED;
