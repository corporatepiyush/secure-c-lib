...
/* Maximum length of any single string value in bytes (excl. NUL).
 * Prevents unbounded heap growth from maliciously long string tokens. */
#ifndef SCL_JSON_MAX_STRING_LEN
#define SCL_JSON_MAX_STRING_LEN (64U * 1024) /* 64 KB */
#endif

/* Maximum nesting depth for objects/arrays (tokens, not bytes). */
#ifndef SCL_JSON_MAX_DEPTH
#define SCL_JSON_MAX_DEPTH 256
#endif
