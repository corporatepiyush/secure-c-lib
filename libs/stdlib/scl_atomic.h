...
/* Header-only atomic operations proxy. Targets C11 <stdatomic.h> with a __sync_builtins fallback for older GCC. All standard memory orders plus scl_atomic_signal_fence. */
