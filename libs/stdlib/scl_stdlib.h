...
/* Safe stdlib wrappers: scl_atoi (range-checked), scl_abs (INT_MIN-safe), thread-local splitmix64 PRNG. Bounds-checks all conversions; returns clamped values on overflow. */
