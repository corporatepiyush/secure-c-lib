...
/* Xoshiro256** PRNG (256-bit state, 64-bit output, passes BigCrush). Splitmix64 seeding. Fastest non-crypto PRNG. */
...
scl_error_t scl_rand_prng_init_array(scl_rand_prng_t * rng, const uint64_t * state) SCL_WARN_UNUSED;
