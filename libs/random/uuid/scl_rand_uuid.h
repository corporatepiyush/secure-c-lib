...
scl_error_t scl_rand_uuid_to_string(const scl_rand_uuid_t *uuid,
                                    char *out) SCL_WARN_UNUSED;
scl_error_t scl_rand_uuid_from_string(const char *str,
                                      scl_rand_uuid_t *uuid) SCL_WARN_UNUSED;
SCL_PURE int scl_rand_uuid_compare(const scl_rand_uuid_t *a,
                                   const scl_rand_uuid_t *b);
