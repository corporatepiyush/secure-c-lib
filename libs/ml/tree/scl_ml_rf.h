...
#define SCL_ML_RF_PARAMS_DEFAULT() \
    { .n_estimators = 100, .max_depth = 0, .min_samples_split = 2, \
      .min_samples_leaf = 1, .max_features = 0, \
      .criterion = SCL_ML_CRITERION_GINI, .random_seed = -1, \
      .n_threads = 0, .verbose = 0, .alloc = NULL }
