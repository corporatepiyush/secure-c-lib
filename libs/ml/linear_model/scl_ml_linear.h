...
typedef struct {
    ...
    scl_ml_penalty_t   penalty;          /* SCL_ML_PENALTY_NONE (OLS), _L1, _L2, _ELASTICNET */
...
#define SCL_ML_LINEAR_PARAMS_DEFAULT() \
    { .solver = SCL_ML_SOLVER_AUTO, .penalty = SCL_ML_PENALTY_NONE, \
      .alpha = 0.0, .l1_ratio = 0.5, .learning_rate = 0.0, \
