...
scl_error_t scl_array_init(scl_array_t *arr, size_t element_size, size_t initial_capacity) SCL_WARN_UNUSED;
void        scl_array_destroy(scl_array_t *arr);
scl_error_t scl_array_push(scl_array_t *arr, const void *element) SCL_WARN_UNUSED;
...
scl_error_t scl_array_insert(scl_array_t *arr, size_t index, const void *element) SCL_WARN_UNUSED;
scl_error_t scl_array_remove(scl_array_t *arr, size_t index, void *out) SCL_WARN_UNUSED;
scl_error_t scl_array_reserve(scl_array_t *arr, size_t new_capacity) SCL_WARN_UNUSED;
scl_error_t scl_array_shrink(scl_array_t *arr) SCL_WARN_UNUSED;
