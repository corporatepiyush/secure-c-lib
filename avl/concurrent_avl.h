...
typedef struct scl_atomic_avl_node {
    void *data;
    struct scl_atomic_avl_node *left;
    struct scl_atomic_avl_node *right;
    int height;
} scl_atomic_avl_node_t;

typedef struct {
    scl_atomic_avl_node_t *root;
    size_t element_size;
    atomic_size_t count;
    scl_cmp_func_t cmp;
    atomic_flag lock;
...
scl_error_t scl_atomic_avl_insert(scl_allocator_t *alloc, scl_atomic_avl_t *tree, const void *element) SCL_WARN_UNUSED;
scl_error_t scl_atomic_avl_remove(scl_allocator_t *alloc, scl_atomic_avl_t *tree, const void *key) SCL_WARN_UNUSED;
bool        scl_atomic_avl_contains(scl_atomic_avl_t *tree, const void *key);
scl_error_t scl_atomic_avl_find(scl_atomic_avl_t *tree, const void *key, void *out) SCL_WARN_UNUSED;
