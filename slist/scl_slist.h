...
scl_error_t scl_slist_push_front(scl_slist_t *list, const void *element) SCL_WARN_UNUSED;
scl_error_t scl_slist_push_back(scl_slist_t *list, const void *element) SCL_WARN_UNUSED;
scl_error_t scl_slist_pop_front(scl_slist_t *list, void *out) SCL_WARN_UNUSED;
