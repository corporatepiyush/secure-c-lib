...
typedef int64_t (*scl_concurrent_segtree_op_t)(int64_t a, int64_t b);

typedef struct {
    int64_t *tree;
    size_t n;
    size_t size;
    scl_concurrent_segtree_op_t op;
    int64_t identity;
    atomic_flag lock;
} scl_concurrent_segtree_t;

scl_error_t scl_concurrent_segtree_init(scl_concurrent_segtree_t *st, const int64_t *data, size_t n,
                                        scl_concurrent_segtree_op_t op, int64_t identity) SCL_WARN_UNUSED;
void        scl_concurrent_segtree_destroy(scl_concurrent_segtree_t *st);
scl_error_t scl_concurrent_segtree_update(scl_concurrent_segtree_t *st, size_t index, int64_t value) SCL_WARN_UNUSED;
